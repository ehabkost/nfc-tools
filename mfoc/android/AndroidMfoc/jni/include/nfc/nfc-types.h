/** Fake nfc-types.h file
 *
 * This just has to contain what's essential for mfoc to work.
 * 
 * Contains portions of nfc-types.h from libnfc.
 * 
 ...
 */
#ifndef __FAKE_NFC_TYPES_H__
#define __FAKE_NFC_TYPES_H__
